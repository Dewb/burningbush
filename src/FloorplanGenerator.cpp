...
//        }
    ...
    void place_vertical_circulation(FloorplanGeneratorState& state) {
    
    }

    void place_functional_space(FloorplanGeneratorState& state) {
        Space space;
    ...
    void place_services(FloorplanGeneratorState& state) {
